...
export const merchData = [
  ...
  { id: "tshirt-2", name: "Technicia Classic Sweatshirt", description: "Stay cool and confident with this sleek Technicia T-shirt — soft fabric, bold look, and all-day comfort.", price: 499, category: "T-Shirts", image: "/merch/tshirts/teecu.jpg", inStock: true },
  { id: "tshirt-4", name: "Technicia Full-Sleeve Sweatshirt", description: "Elevate your casual wear with this full-sleeve Technicia T-shirt — perfect for every season.", price: 499, category: "T-Shirts", image: "/merch/tshirts/teefull.jpg", inStock: true },
  ...
  { id: "tshirt-8", name: "Technicia Signature Tee", description: "Experience comfort and design perfection with the Technicia signature collection.", price: 499, category: "T-Shirts", image: "/merch/tshirts/tesscu.jpg", inStock: true },
  ...
  { id: "tshirt-28", name: "Technicia Streetwear Tee", description: "Urban vibes meet campus style — wear your Technicia pride with confidence.", price: 499, category: "T-Shirts", image: "/merch/tshirts/4.png", inStock: true },
  { id: "tshirt-24", name: "Technicia Edition Tee", description: "Limited Technicia edition — fresh, stylish, and crafted to impress.", price: 499, category: "T-Shirts", image: "/merch/tshirts/7.png", inStock: true },
  { id: "tshirt-25", name: "Technicia Vibe Tee", description: "Turn heads with the Technicia Vibe tee — a perfect blend of comfort and personality.", price: 499, category: "T-Shirts", image: "/merch/tshirts/8.png", inStock: true },
  { id: "tshirt-26", name: "Technicia Black Tee", description: "Bold and timeless — the all-black Technicia tee that goes with everything.", price: 499, category: "T-Shirts", image: "/merch/tshirts/9.png", inStock: true },
  { id: "tshirt-27", name: "Technicia Graphic Tee", description: "Bring your look to life with the Technicia graphic print — fresh and full of attitude.", price: 499, category: "T-Shirts", image: "/merch/tshirts/10.png", inStock: true },
  { id: "tshirt-15", name: "Technicia Street Classic", description: "Streetwear with a Technicia twist — bold, breathable, and built for style.", price: 499, category: "T-Shirts", image: "/merch/tshirts/15.png", inStock: true },
  { id: "tshirt-18", name: "Technicia Minimal Tee", description: "Simple yet stunning — embrace minimalism with Technicia’s soft-touch tee.", price: 499, category: "T-Shirts", image: "/merch/tshirts/18.png", inStock: true },
  { id: "tshirt-20", name: "Technicia Prime Tee", description: "Designed for comfort and confidence — your go-to Technicia prime edition tee.", price: 499, category: "T-Shirts", image: "/merch/tshirts/20.png", inStock: true },
  { id: "tshirt-22", name: "Technicia Elite Tee", description: "Step into excellence with the Technicia Elite tee — made for leaders, not followers.", price: 499, category: "T-Shirts", image: "/merch/tshirts/22.png", inStock: true },
