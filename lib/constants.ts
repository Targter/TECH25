...
export const merchData = [
  ...
  { id: "tshirt-28", name: "Technicia T-Shirt", description: "Urban vibes meet campus style — wear your Technicia pride with confidence.", price: 499, category: "T-Shirts", image: "/merch/tshirts/4.png", inStock: true },
  { id: "tshirt-24", name: "Technicia T-Shirt", description: "Limited Technicia edition — fresh, stylish, and crafted to impress.", price: 499, category: "T-Shirts", image: "/merch/tshirts/7.png", inStock: true },
  { id: "tshirt-25", name: "Technicia T-Shirt", description: "Turn heads with the Technicia Vibe tee — a perfect blend of comfort and personality.", price: 499, category: "T-Shirts", image: "/merch/tshirts/8.png", inStock: true },
  { id: "tshirt-26", name: "Technicia T-Shirt", description: "Bold and timeless — the all-black Technicia tee that goes with everything.", price: 499, category: "T-Shirts", image: "/merch/tshirts/9.png", inStock: true },
  { id: "tshirt-27", name: "Technicia T-Shirt", description: "Bring your look to life with the Technicia graphic print — fresh and full of attitude.", price: 499, category: "T-Shirts", image: "/merch/tshirts/10.png", inStock: true },
  { id: "tshirt-15", name: "Technicia T-Shirt", description: "Streetwear with a Technicia twist — bold, breathable, and built for style.", price: 499, category: "T-Shirts", image: "/merch/tshirts/15.png", inStock: true },
  { id: "tshirt-18", name: "Technicia T-Shirt", description: "Simple yet stunning — embrace minimalism with Technicia’s soft-touch tee.", price: 499, category: "T-Shirts", image: "/merch/tshirts/18.png", inStock: true },
